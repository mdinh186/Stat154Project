...
We fit a random forest with 10 from `caret` package using three techniques as described above. Random search to tune hyperparameter is implemented simultaneoulsy while training the model to find which models has the most accurarcy. 
